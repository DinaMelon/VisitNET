...
//==================================================================
// СКРИПТ: InteractReycast
// НАЗНАЧЕНИЕ: Обрабатывает взаимодействие игрока с объектами по клику мыши
// ЧТО ДЕЛАЕТ: Луч из центра камеры (Reycast) ищет объекты с компонентом InteractObject
//              Подсвечивает их при наведении. При клике ЛКМ вызывает ShowInfo()
// ЗАВИСИМОСТИ: объекты должны иметь InteractObject и коллайдер
//==================================================================
