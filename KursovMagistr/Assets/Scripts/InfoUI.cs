...
//==================================================================
// СКРИПТ: InfoUI
// НАЗНАЧЕНИЕ: Показывает всплывающую панель с информацией об объекте (текст и картинка)
// ВЫЗОВ ИЗ ДРУГИХ СКРИПТОВ: InfoUI.instance.ShowInfo("Текст", картинка)
// ЗАКРЫТИЕ: Нажатие E, Q, W (ПК) или мобильные кнопки
//==================================================================
